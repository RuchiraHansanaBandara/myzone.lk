        ...
        <div class="row">
            <div class="col-sm-12 table-inside">
                ...
                <table class="table table-striped table-sm">
                    ...
                    <?php
                    $sql="SELECT o.orderId,p.product_title,o.quantity,o.amount,p.sellerID,o.addrline1,o.addrline2,o.addrcity,o.orderDate,o.shipStatus,o.orderReceive FROM orders o,products p WHERE p.product_id=o.prodId AND o.userID=1 AND o.orderReceive='Received'";

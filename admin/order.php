        ...
        <div class="row">
            <div class="col-sm-12 table-inside">
                ...
                <table class="table table-striped table-sm">
                    ...
                    <?php
                    $sql="SELECT o.orderId,p.product_title,o.quantity,o.amount,o.userID,o.addrline1,o.addrline2,o.addrcity,o.orderDate,o.shipStatus,o.orderReceive FROM orders o,products p WHERE p.product_id=o.prodId AND p.sellerID=1";
                        ...
                        while($rows=$result->fetch_assoc()){
                            echo'
                                <tr>
                                    ...
                                    <td>'.($rows['shipStatus']=="pending"?'<a href="include/update_staus.php?oid='.$rows['orderId'].'">'.$rows['shipStatus'].'</a>':'Done').'</td>
                                    <td>'.$rows['orderReceive'].'</td>
                                </tr>
                            ';
                        }
                    }else{

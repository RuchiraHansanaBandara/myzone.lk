<?php
    ...
    if(isset($_POST['btnSubmit'])){
        ...
        $sql="INSERT INTO products (product_title,product_price,product_description,product_category_id,sellerID) VALUES ('{$productName}','{$productPrice}','{$productDescription}','{$productCategory}',2)";
